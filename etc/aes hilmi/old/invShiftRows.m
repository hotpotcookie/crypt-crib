...
function s_out = invShiftRows(s_in)
...
s_out(2,1) = s_in(2,4)   ; s_out(2,2) = s_in(2,1) ; s_out(2,3) = s_in(2,2) ; s_out(2,4) = s_in(2,3);
s_out(3,1) = s_in(3,3)   ; s_out(3,2) = s_in(3,4) ; s_out(3,3) = s_in(3,1) ; s_out(3,4) = s_in(3,2);
s_out(4,1) = s_in(4,2)   ; s_out(4,2) = s_in(4,3) ; s_out(4,3) = s_in(4,4) ; s_out(4,4) = s_in(4,1);
